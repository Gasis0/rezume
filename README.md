...
3. конкурс троектория будущего (https://tbolimpiada.ru/onenews/241) добавить ссылку на папку с сетрификатами, IT-планета, доктрина или интеграция (участие в полуфинале в траектории отменяет доктрину и интеграцию (должен быть сертификат)) 
